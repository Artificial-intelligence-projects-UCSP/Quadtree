...
if __name__ == '__main__':
    ...
    print("Escribir el nombre de la imagen")
    image_path = input()
    print("Escribir la extensión de la imagen")
    image_extent=input()
    # load image
    image = Image.open(image_path+"."+image_extent)
    ...
    image.save(image_path+"quadtree"+"."+image_extent)